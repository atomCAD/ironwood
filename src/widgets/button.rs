...
mod tests {
    ...
    #[test]
    fn enableable_trait_implementation() {
        // Test Enableable trait methods
        let button = Button::new("Enableable Test");

        // Test initial state
        assert!(button.is_enabled());

        // Test disable
        let disabled = button.clone().disable();
        assert!(!disabled.is_enabled());
        ...
        // Test with_enabled
        let conditionally_enabled = button.clone().with_enabled(false);
    ...
    #[test]
    fn pressable_trait_implementation() {
        // Test Pressable trait methods
        let button = Button::new("Pressable Test");

        // Test initial state
        assert!(!button.is_pressed());

        // Test press
        let pressed = button.clone().press();
        ...
        // Test with_pressed
        let conditionally_pressed = button.clone().with_pressed(true);
    ...
    #[test]
    fn focusable_trait_implementation() {
        // Test Focusable trait methods
        let button = Button::new("Focusable Test");
        ...
        // Test focus
        let focused = button.clone().focus();
        ...
        // Test with_focused
        let conditionally_focused = button.clone().with_focused(true);
        ...
        let disabled_button = button.disable();
        assert!(!disabled_button.can_receive_focus());
    }

    #[test]
    fn hoverable_trait_implementation() {
        // Test Hoverable trait methods
        let button = Button::new("Hoverable Test");

        // Test initial state
        assert!(!button.is_hovered());

        // Test hover
        let hovered = button.clone().hover();
        ...
        // Test with_hovered
        let conditionally_hovered = button.clone().with_hovered(true);
